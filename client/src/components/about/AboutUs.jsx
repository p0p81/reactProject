...
export default function AboutUs() {
  return (
    <div className="about-us">
      ...
      <p>
        Welcome to <strong className="highlight">HOME EXPERTS</strong> website, your one-stop destination for finding and advertising professional services in various fields. 
